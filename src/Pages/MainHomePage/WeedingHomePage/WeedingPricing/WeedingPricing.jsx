    ...
    <div className="">
      ...
      <div className="bg-[#f0f7f7] min-h-screen py-[100px]">
        ...
        <div className="max-w-4xl mx-auto py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 mt-[50px]">
            <div>
              <img
          ...
          <div>
            <div className="flex flex-col items-center mb-6">
              <img
                ...
                alt="Instagram Icon"
              />
              <h2 className="text-black text-[50px] font-semibold mt-2">Instagram Feed</h2>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-[-100px]">
              {instagramData.map(({ id, imgSrc, link, alt }) => (
                <div key={id} className="relative flex flex-col items-center group">
                  ...
                  />
                  <a
                    className="absolute inset-10  flex items-center justify-center bg-white text-black px-4 py-2 rounded shadow opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                    href={link}
                    target="_blank"
