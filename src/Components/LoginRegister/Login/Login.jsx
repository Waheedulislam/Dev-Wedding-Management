    ...
    return (
        <div className="flex h-screen items-center justify-center bg-gray-100">
            <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-md">
                <h2 className="text-4xl font-bold mb-8 text-center text-gray-800">Login Now</h2>
                ...
                <p className="text-sm text-center text-gray-600 mt-6">
                    Do not have an account? <Link to='/weeding/register' className="text-blue-500 hover:underline">Register here</Link>
                </p>
            </div>
        </div>
    )
